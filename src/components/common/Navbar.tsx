    ...
    <>
      <div className=" z-[55] fixed top-0 left-0 w-[100%]">
        ...
        <div className="Navbar-font relative flex flex-row items-center justify-between border-b border-gray-400 pb-4 pt-3 px-4 bg-white shadow-md">
          ...
          {/* Brand */}
          <Link href={"/"}>
            <h2 className=" custom-verora text-2xl font-semibold ml-10 fontStyleForLogo">
              Verora
            </h2>
          </Link>
          ...
          <div className="flex gap-x-1">
            ...
            {showBar ? (
              <div className="searchBar absolute right-[23%] p-1 bottom-2 sm:w-[60%]  rounded-[12px] items-center bg-white shadow-md flex ">
                ...
                <input
                  ...
                  className=" outline-none items-center py-2 rounded-[10px]  text-gray-600 placeholder-gray-500 bg-transparent"
                />
                <svg
                  onClick={() => {
                    setShowBar(false);
      ...
      {showCard && (
        <div className="fixed z-[100]  right-0 top-0">
      ...
      {menuOpen && (
        <div
          className="Navbarlinks fixed top-0  left-0 w-[75%] bg-white z-[100] bottom-0 shadow-lg transition-transform duration-30 ease-in-out
        flex flex-col
        "
        >
          ...
          <div className="border-b-2 mt-2 flex justify-between items-center px-4 py-2">
            <h1 className="custom-verora text-3xl font-bold ">Verora</h1>
            <button
        ...
        overflow-auto "
          >
            ...
            <ul className="flex flex-col gap-4 ml-4 mt-6 text-[16px] ">
              <Link href={"/"}>
                <li className="cursor-pointer flex items-center justify-between mr-2 hover:font-semibold">
                  Home
                  <span>
                    <FaChevronRight />
                  </span>
